...
#define HAL_KEY_SW_7_ICTLBIT  BV(2) /* P0IEN - P1.2 enable/disable bit */
...
/* 23/12/2010 ++ by feibit */
#if ((!defined FB2530BB) && (!defined ZB2530_01))
  if ((HAL_KEY_JOY_MOVE_PORT & HAL_KEY_JOY_MOVE_BIT))  /* Key is active HIGH */
  {
    keys = halGetJoyKeyInput();   //ÕâÀïµ¼ÖÂÁË°´¼üsw6 µÄ²»¶ÔÓ¦£¬¼´Ã»ÓÐÈÃËü¶¯×÷£¬ËüÈ´Ö´ÐÐÁËjoystickµÄup¹¦ÄÜ
  }
#endif
