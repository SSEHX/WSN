                                ...
                                byte SecurityEnable )
{
  ...
  len += (NumInClusters + NumOutClusters) * sizeof(uint16);  //len = 8  (the length of byte)
  
 // HalLcdWriteStringValue( "len :", len , 16, HAL_LCD_LINE_2);
  ...
  *pBuf++ = HI_UINT16( ProfileID );
   ...
   //HalLcdWriteStringValue( "nwkAddr :", nwkAddr , 16, HAL_LCD_LINE_2);
