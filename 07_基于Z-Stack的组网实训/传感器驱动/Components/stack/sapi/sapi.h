...
/* 2/1/2011 ++ by feibit */
#if TEMP_SRC == TEMP_SRC_OUTER
#define MY_PUSHADC_EVT							0x0008
#endif

#if defined CL_UART0
#define MY_UART0_START_EVT        0x0010
#define MY_SET_MODE_EVT              0x0020
#define MY_REC_DATA_EVT              0x0040
#endif

#if defined SENSOR_SHT10
#define MY_SHT10_EVT			0x0008
#endif
