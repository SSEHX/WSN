...
#define SENSOR_REPORT_LENGTH              9// 4

#define SENSOR_HUMIDITY_OFFSET             4
#define SENSOR_TEMP2_OFFSET                5
#define SENSOR_X_OFFSET                6
#define SENSOR_Y_OFFSET                7
#define SENSOR_Z_OFFSET                8
...
void hal_SensorInit(void);//Append by Ryan
