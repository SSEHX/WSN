...
void initUart(halUARTCBack_t pf)
{
  ...
  osal_nv_read(ZDO_NV_MYAPP_BAUD, 0, 1, & configbaud);

  switch(configbaud)
  {
	case 0x01 : uartConfig.baudRate = HAL_UART_BR_115200; break;

	default : uartConfig.baudRate = HAL_UART_BR_38400; break;
  }
