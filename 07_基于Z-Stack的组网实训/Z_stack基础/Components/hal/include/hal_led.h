...
/* Modes */
#define HAL_LED_MODE_OFF     0x00//0xff//0x00
#define HAL_LED_MODE_ON      0x01//0xfe//0x01
#define HAL_LED_MODE_BLINK   0x02//0xfd//0x02
#define HAL_LED_MODE_FLASH   0x04//0xfb//0x04
#define HAL_LED_MODE_TOGGLE  0x08//0xf7//0x08
