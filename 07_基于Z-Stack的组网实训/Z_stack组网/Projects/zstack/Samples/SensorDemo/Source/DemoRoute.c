...
static uint16 myReportPeriod =      3580;        // milliseconds
 ...
 * @return      none
 */
#define ROUTE_REPORT_LENGTH 5
static void sendDummyReport(void)
{
  uint8 pData[ROUTE_REPORT_LENGTH];
  ...
  pData[SENSOR_PARENT_OFFSET+ 2] =  LOG_TYPE;   //路由
  ...
  zb_SendDataRequest( 0xFFFE, DUMMY_REPORT_CMD_ID, ROUTE_REPORT_LENGTH, pData, 0, txOptions, 0 );
}
