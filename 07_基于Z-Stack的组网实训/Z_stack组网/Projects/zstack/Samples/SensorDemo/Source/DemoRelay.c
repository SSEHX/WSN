...
static uint16 myReportPeriod =      2136;        // milliseconds
...
void zb_HandleOsalEvent( uint16 event )
{
  ...
  { 
    ...
    HalLedBlink ( HAL_LED_2, 0, 20, 2750);
 ...
 * @return      none
 */
void sendreplay(uint8* pData, uint8 len)
{
	...
	zb_SendDataRequest( 0xFFFE, DUMMY_REPORT_CMD_ID , len, pData, 0, txOptions, 0 );
}
/*********************************************************************/
