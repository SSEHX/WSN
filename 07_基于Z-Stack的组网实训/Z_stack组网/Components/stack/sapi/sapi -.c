  ...
  if ( events & ( ZB_TIME_EVENT ) )
  {
    ...
    test_read_flash();
      ...
      uart_printf("数据：");
                ...
                i=(int)S.DateString1[0]*256+S.DateString1[1];
                j=(int)S.DateString1[2]*256+S.DateString1[3];
                uart_printf("温度：%d.%d, 湿度：%d.%d\r\n",i/10,i%10,j/10,j%10);
      
      osal_start_timerEx( sapi_TaskID, ZB_TIME_EVENT,2000 );
